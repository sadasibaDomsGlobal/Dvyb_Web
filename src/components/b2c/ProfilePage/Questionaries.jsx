...
const hairStyles = ["Wavy", "Straight", "Coily", "Curly"];
  ...
  const bodyTypes = [
    { id: 'fat', label: 'Fat Body', icon: '🟡',img : 'https://res.cloudinary.com/doiezptnn/image/upload/v1757674507/Group_yiszhq.png' },
    { id: 'normal', label: 'Normal Body', icon: '🔵',img : 'https://res.cloudinary.com/doiezptnn/image/upload/v1757674506/noun-normal-woman-body-687036_1_hklqpb.png' },
    { id: 'superfit', label: 'Super Fit Body', icon: '💪',img : 'https://res.cloudinary.com/doiezptnn/image/upload/v1757674506/noun-sexy-woman-body-687032_1_guoflx.png' },
    { id: 'slim', label: 'Slim Body', icon: '📏' ,img : 'https://res.cloudinary.com/doiezptnn/image/upload/v1757674506/Group_1_ijia0z.png'}
  ];
