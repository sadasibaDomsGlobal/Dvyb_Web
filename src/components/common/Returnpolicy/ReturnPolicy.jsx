...
export default function ReturnExchangePolicy() {
  return (
    <div className=" mx-16 px-4 py-8 bg-white ">
      ...
      {/* Title */}
      <h2 className="mb-1 font-medium">Return & Exchange Policy</h2>
      ...
      {/* 7-Day Return Policy */}
      <h3 className="font-medium mb-2 text-2xl">7-Day Return Policy for Domestic Orders Only</h3>
      ...
      {/* Return Charges */}
      <h3 className=" font-normal mb-2">Return Charges</h3>
      <h4 className=" font-normal mb-2">Domestic Orders:</h4>
      ...
      {/* How to Initiate */}
      <h4 className="font-medium text-2xl mb-2">How to Initiate the Refund Process?</h4>
      <p className="text-sm font-normal text-gray-700 mb-2">
      ...
      {/* Refund */}
      <h4 className="font-medium text-2xl mb-2">Refund</h4>
      <p className="text-sm font-normal text-gray-700 mb-2">
      ...
      {/* Domestic Orders */}
      <h4 className="font-medium text-2xl mb-2">Domestic Orders:</h4>
      <p className="text-sm font-normal text-gray-700 mb-2">
      ...
      <h4 className="font-medium text-2xl mb-2">International Orders:</h4>
      <p className="text-sm font-normal text-gray-700 mb-2">
      ...
      <p className="text-smfont-normal text-gray-700 mb-2">
      ...
      {/* Exchange */}
      <h3 className="font-medium text-2xl mb-2">Exchange</h3>
      <p className="text-sm font-normal text-gray-700 mb-6">
      ...
      {/* Disclaimer */}
      <h3 className="font-medium text-2xl mb-2">Disclaimer</h3>
      <p className="text-sm font-normal text-gray-700 mb-2">
      ...
      {/* Website Content */}
      <h3 className="font-medium text-2xl mb-2">Website Content</h3>
      <p className="text-sm font-normal text-gray-700 mb-2">
      ...
      {/* External Material */}
      <h3 className="font-medium text-2xl mb-2">External Material</h3>
      <p className="text-sm font-normal text-gray-700 mb-2">
      ...
      {/* Links */}
      <h3 className="font-medium text-2xl mb-2">Links</h3>
      <p className="text-sm font-normal text-gray-700 mb-6">
      ...
      {/* Liability */}
      <h3 className="font-medium text-2xl mb-2">Liability</h3>
      <p className="text-sm font-normal text-gray-700 mb-2">
      ...
      <p className="font-medium text-2xl mb-2">NOTE:</p>
      <p className="text-sm font-normal text-gray-700 mb-6">
      ...
      {/* Cancellation Policy */}
      <h3 className="font-medium text-3xl mb-2">Cancellation Policy</h3>
      <h4 className="font-medium text-2xl mb-2">Cancellation by Dryb Company Limited</h4>
      <p className="text-sm font-normal text-gray-700 mb-6">
      ...
      <h4 className="font-medium text-2xl mb-2">Cancellation by Customer</h4>
      <p className="text-sm font-normal text-gray-700 mb-2">
