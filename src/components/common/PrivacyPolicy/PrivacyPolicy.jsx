  ...
  return (
    <div className="min-h-screen bg-white ">
      ...
      <div className="max-w-3xl mx-auto px-1 py-8">
        <h2 className="mb-1 text-bold ">Privacy Policy</h2>
        ...
        <section className="mb-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-700">Device type, operating system, unique device identifiers, IP address.</p>
            </div>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700">
            <li><span className="font-bold">Service Providers:</span> Payment gateways, delivery partners, cloud storage providers.</li>
            <li><span className="font-bold">Business Partners:</span> To provide offers, promotions, or additional services.</li>
            <li><span className="font-bold">Legal Authorities:</span> If required by law or to protect rights, safety, and property.</li>
          </ul>
        </section>
        ...
        <section className="mb-6  p-4">
          ...
          <p className="text-gray-700 mb-3">If you have questions or concerns about this Privacy Policy, please contact us at:</p>
