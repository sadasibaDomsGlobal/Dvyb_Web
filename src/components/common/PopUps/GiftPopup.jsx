  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-30 z-50">
      <div className="bg-pink-100 p-8 rounded-md w-[90%] md:w-[750px] flex flex-col md:flex-row justify-between items-center relative shadow-xl">
        {/* Close button */}
        <button className="absolute top-3 right-4 text-black text-2xl font-semibold hover:text-gray-600">
          ×
        </button>
        ...
        <div className="w-full md:w-1/2 space-y-5">
          ...
          <form className="space-y-3">
            ...
            <button
              type="submit"
              className="w-full bg-black text-white py-2 mt-2 font-semibold hover:bg-gray-800 transition"
            >
              SAVE AND CONTINUE
            </button>
          </form>
