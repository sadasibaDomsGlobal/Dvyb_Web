...
/**
 * DVYB-style Checkout page (pin-to-pin)
 *
 * - Font: Outfit (uses className 'font-[Outfit]')
 * - Left panel blocks sized: 685 x 401 (inner content area)
 * - Right panel fixed: 395 x 1188
 * - Gap between containers: 24px (gap-6)
 * - Accordion: only one open at a time; step unlocking:
 *     Step1 (email) -> unlock Step2
 *     Step2 (shipping fields) -> unlock Step3
 *
 * NOTE: keep your existing subscribeToCart implementation.
 */
