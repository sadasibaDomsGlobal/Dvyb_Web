  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center">
      ...
      <div className="px-5 pb-8 max-w-2xl w-full">
        ...
        {/* Intro */}
        <p className="text-xl font-light text-gray-700 leading-relaxed mb-6">
        ...
        <p className="text-xl font-light text-gray-700 leading-relaxed mb-2">
        ...
        <ul className="space-y-2 mb-6">
          <li className="text-xl font-light text-gray-700 leading-relaxed flex">
        ...
        <div className="space-y-2">
          <p className="text-xl font-light text-gray-700 leading-relaxed flex items-center">
            <span className="mr-2">✉</span>
